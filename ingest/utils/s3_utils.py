...
from config import AWS_ACCESS_KEY_ID, AWS_REGION, AWS_S3_BUCKET, AWS_SECRET_ACCESS_KEY
...
def list_gold_files():
    response = s3_client.list_objects_v2(Bucket=AWS_S3_BUCKET, Prefix="gold/model/")
